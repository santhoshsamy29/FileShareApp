...
public class AllFilesActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    downloadTask.execute(Pair.create(response.body(), "DalalMessage_1553546072.proto"));
    ...
    private class DownloadTask extends AsyncTask<Pair<ResponseBody, String>, Pair<Integer, Long>, String> {
