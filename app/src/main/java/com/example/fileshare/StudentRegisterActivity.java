...
public class StudentRegisterActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        nameEditText = findViewById(R.id.student_nameEditText);
        emailEditText = findViewById(R.id.student_emailEditText);
        passwordEditText = findViewById(R.id.student_passwordEditText);
        confirmPasswordEditText = findViewById(R.id.student_confirmPasswordEditText);
    }
    ...
    private void register(String name, String email, String password) {
        ...
        call.enqueue(new Callback<StandardResponse>() {
            ...
            public void onResponse(Call<StandardResponse> call, Response<StandardResponse> response) {
                ...
                Toast.makeText(StudentRegisterActivity.this, data, Toast.LENGTH_SHORT).show();
